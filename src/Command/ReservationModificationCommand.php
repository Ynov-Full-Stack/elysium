...
#[AsCommand(
    name: 'app:mail:reservationEdi',
    description: 'Send a test reservation email'
)]
class ReservationModificationCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->mailService->send(MailMessage::reservationModification($currentUser, $currentReservation));

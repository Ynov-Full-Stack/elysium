...
#[AsCommand(
    name: 'app:mail:adminReservationDel',
    description: 'Send a test reservation email'
)]
class AdminReservationCancellationCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->mailService->send(MailMessage::adminReservationCancellation($currentUser, $currentReservation));

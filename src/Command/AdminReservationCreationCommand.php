...
#[AsCommand(
    name: 'app:mail:adminReservationCre',
    description: 'Send a test reservation email'
)]
class AdminReservationCreationCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->mailService->send(MailMessage::adminReservationCreation($currentUser, $currentReservation));

...
#[AsCommand(
    name: 'app:mail:reservationDel',
    description: 'Send a test reservation email'
)]
class ReservationCancellationCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->mailService->send(MailMessage::reservationCancellation($currentUser, $currentReservation));

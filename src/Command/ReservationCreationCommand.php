...
#[AsCommand(
    name: 'app:mail:reservationCre',
    description: 'Send a test reservation email'
)]
class ReservationCreationCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->mailService->send(MailMessage::reservationCreation($currentUser, $currentReservation));
